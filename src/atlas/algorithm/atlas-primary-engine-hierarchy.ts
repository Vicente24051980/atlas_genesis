export const ATLAS_PRIMARY_ENGINE_HIERARCHY = {
  version: '2026-08-21-v4.6.0',
  firstAnalyticalEngine: 'GREEN_CONTINUITY_OMEGA_V1_2',
  primaryEngine: 'PRINCIPAL_OMEGA',
  primaryRole: 'structural_selection_quality_growth_asymmetry',
  refinementEngines: [
    'GREEN_CONTINUITY_OMEGA_V1_2', 'GREEN_PULSE_OMEGA', 'GREEN_BREADTH_OMEGA', 'RELATIVE_GREEN_OMEGA',
  ...
  rules: [
    'After integrity and ticker-identity normalization, GREEN CONTINUITY Ω is always the first analytical motor.',
