export const ATLAS_PRIMARY_ENGINE_HIERARCHY = {
  ...
  refinementEngines: [
    ...
    'CAPITAL_ALLOCATION_QUALITY_OMEGA_V1', 'STRUCTURAL_TIER_PRIORITY_OMEGA_V1', 'EXPECTED_CAGR_DRIVER_BRIDGE_OMEGA_V1', 'VALUATION_COMPRESSION_STRESS_OMEGA_V1',
