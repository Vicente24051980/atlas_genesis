...
export const ATLAS_PRIMARY_ENGINE_HIERARCHY = {
  ...
  rules: [
    ...
    'SOVEREIGN GOLD ACCUMULATION Ω separates verified central-bank purchases from private demand, jewellery demand and unverified hidden-buying claims; gold momentum alone cannot confirm sovereign flow.',
