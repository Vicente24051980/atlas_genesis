...
const styles = StyleSheet.create({
  ...
  brand: { color: '#f0f5f8', fontSize: 24, fontWeight: '900', letterSpacing: 1.6 },
  product: { color: '#536678', fontSize: 7, fontWeight: '900', letterSpacing: 1.8, marginTop: 2 },
  ...
  connectionText: { color: '#7e91a3', fontSize: 7, fontWeight: '900' },
  hero: { backgroundColor: '#081018', borderWidth: 1, borderColor: '#183044', borderRadius: 11, padding: 15, gap: 7 },
  heroEyebrow: { color: '#64d8ff', fontSize: 8, fontWeight: '900', letterSpacing: 1.4 },
  heroTitle: { color: '#edf4f8', fontSize: 26, fontWeight: '900', letterSpacing: -0.5 },
  ...
  statusLabel: { color: '#4e6173', fontSize: 6, fontWeight: '900' },
  statusValue: { color: '#8c9cab', fontSize: 8, fontWeight: '900', marginTop: 2 },
  good: { color: '#50dba3' },
  apiWarning: { borderWidth: 1, borderColor: '#5a421b', backgroundColor: '#181208', borderRadius: 8, padding: 10 },
  apiWarningTitle: { color: '#ddba59', fontSize: 8, fontWeight: '900' },
  ...
  kpiValue: { color: '#d7e1e9', fontSize: 20, fontWeight: '900' },
  kpiLabel: { color: '#506274', fontSize: 6, fontWeight: '900', marginTop: 3 },
  section: { color: '#566a7d', fontSize: 8, fontWeight: '900', letterSpacing: 1.3, marginTop: 4 },
  ...
  code: { color: '#5ecfea', fontSize: 8, fontWeight: '900', letterSpacing: 1 },
  count: { color: '#667b8e', fontSize: 8, fontWeight: '900' },
  cardTitle: { color: '#dce6ed', fontSize: 14, fontWeight: '900', marginTop: 12 },
  ...
  footerTitle: { color: '#9fb86d', fontSize: 8, fontWeight: '900' },
