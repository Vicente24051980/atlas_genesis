...
const styles = StyleSheet.create({
  ...
  title: { color: '#eff4f8', fontSize: 23, fontWeight: '950', marginTop: 5, maxWidth: 310 },
  ...
  methodTitle: { color: '#a9c078', fontSize: 9, fontWeight: '950' },
  ...
  th: { flex: 1, color: '#506274', fontSize: 8, fontWeight: '950', textAlign: 'right' },
  ...
  ticker: { color: '#dfe8f0', fontWeight: '950', fontSize: 13 },
