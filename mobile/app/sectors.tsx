...
const styles = StyleSheet.create({
  ...
  totalLabel: { color: '#60788d', fontSize: 8, fontWeight: '900', letterSpacing: 1 },
  totalValue: { color: '#eaf3f9', fontSize: 29, fontWeight: '900', marginTop: 5 },
  ...
  weight: { color: '#cdeefa', fontSize: 16, fontWeight: '900' },
