...
const ENGINE_ROUTES: Record<string, '/overview' | '/quality' | '/growth' | '/capex-productivity' | '/valuation' | '/risk' | '/radar' | '/evidence'> = {
  core: '/overview',
  quality: '/quality',
  growth: '/growth',
  capex: '/capex-productivity',
  valuation: '/valuation',
  risk: '/risk',
  rotation: '/radar',
  dislocation: '/radar',
  'agentic-security': '/radar',
  evidence: '/evidence',
};
...
export default function EnginesScreen() {
  ...
  const openEngine = (engine: AtlasEngine) => {
    const route = ENGINE_ROUTES[engine.id];
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Text style={styles.subtitle}>Cada motor tiene función y pantalla propia. El stack completo converge después en la decisión ATLAS Ω.</Text>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#050708' }, content: { padding: 18, paddingBottom: 48, gap: 11 }, pressed: { opacity: 0.58 },
