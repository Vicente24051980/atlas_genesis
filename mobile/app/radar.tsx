...
const styles = StyleSheet.create({
  ...
  title: { color: '#eff4f8', fontSize: 24, fontWeight: '900' },
  ...
  metricLabel: { color: '#526476', fontSize: 6, fontWeight: '900' },
  metricValue: { color: '#b9c7d3', fontSize: 18, fontWeight: '900', marginTop: 3 },
  guard: { backgroundColor: '#161309', borderWidth: 1, borderColor: '#4e4219', borderRadius: 8, padding: 10 },
  guardTitle: { color: '#d8b958', fontSize: 8, fontWeight: '900' },
  ...
  ticker: { color: '#dfe8ef', fontSize: 15, fontWeight: '900' },
  ...
  severityText: { color: '#c5d0da', fontSize: 7, fontWeight: '900' },
  scoreRow: { flexDirection: 'row', gap: 5 },
  smallScore: { flex: 1, backgroundColor: '#0b1219', borderRadius: 6, padding: 7 },
  smallLabel: { color: '#506274', fontSize: 6, fontWeight: '900' },
  smallValue: { color: '#b7c5d1', fontSize: 14, fontWeight: '900', marginTop: 2 },
