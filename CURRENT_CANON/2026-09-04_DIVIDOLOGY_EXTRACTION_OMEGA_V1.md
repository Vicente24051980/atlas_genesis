# ATLAS Ω — DIVIDOLOGY EXTRACTION Ω v1.0
...
Therefore `DIVIDOLOGY_EXTRACTION_OMEGA_V1` has **0 direct ATLAS score weight** until broad, repeated, economically material out-of-sample evidence justifies migration of a genuinely new signal.
...
`DIVIDOLOGY_EXTRACTION_OMEGA_V1` cannot by itself:
