...
3. `Implied Return Ω` sufficient for execution
4. `ENTRY TIMING Ω` not blocked by NO-CHASE
...
For final PASS classification preserve when available:

- ticker / exchange / currency;
- synchronized as-of date;
