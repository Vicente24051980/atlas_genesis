...
4. Bancos y utilities no se fuerzan dentro del filtro industrial de FCF/deuda. Para ABN y JPM, el FCF yield industrial se almacena como `NV` aunque el proveedor publique una cifra derivada.

## Resultado por emisor

| Broker → canónico | GREEN | fPE | FCF yield | Deuda/EBITDA | Upside consenso | Motor dominante | Veredicto |
|---|---:|---:|---:|---:|---:|---|---|
| ABN → `ABN.AS` | 4/5 | 12.50 | NV | NV | -5.16% | Bank Quality / Money Rotation | **SECTOR_NO_CHASE** |
...
| JPM → `JPM` | 5/5 | 15 | NV | NV | 3.27% | Bank Quality / Money Rotation | **SECTOR_HOLD_REVIEW** |
